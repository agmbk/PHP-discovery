...
```
cd existing_repo
git remote add origin https://gitlab.iut-valence.fr/gombouka/devweb_arnaud_yanis.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.iut-valence.fr/gombouka/devweb_arnaud_yanis/-/settings/integrations)
